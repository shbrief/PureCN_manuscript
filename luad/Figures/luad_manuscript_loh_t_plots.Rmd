...
## Load LOH output
```{r}
data_dir = "~/wallabe4_backup/github/PureCN_manuscript_backup"
...
HLA_all = read.csv(file.path(results_dir, "extdata/luad_HLA_all.tsv"))[,-1]   # 297 obs.
```
...
=======
res = t.test(TP53_Agree_purity, TP53_Disagree_purity, var.equal = TRUE)
>>>>>>> 96ebf69334c5473e276c5bbab9659e0d25fb340e
...
neither = which(HLA_all$HLAA_LOH == FALSE & HLA_all$HLAA_LOH_t == FALSE)   # 182
...
=======
res = t.test(HLAA_Agree_purity, HLAA_Disagree_purity, var.equal = TRUE)
>>>>>>> 96ebf69334c5473e276c5bbab9659e0d25fb340e
...
PCN = which(HLA_all$HLAB_LOH == FALSE & HLA_all$HLAB_LOH_t == TRUE)   # 14
...
=======
res = t.test(HLAB_Agree_purity, HLAB_Disagree_purity, var.equal = TRUE)
>>>>>>> 96ebf69334c5473e276c5bbab9659e0d25fb340e
...
neither = which(HLA_all$HLAC_LOH == FALSE & HLA_all$HLAC_LOH_t == FALSE)   # 182
...
=======
res = t.test(HLAC_Agree_purity, HLAC_Disagree_purity, var.equal = TRUE)
>>>>>>> 96ebf69334c5473e276c5bbab9659e0d25fb340e
...
```{r eval=FALSE}
saveRDS(LOH_t_plot, file = "~/wallabe4_backup/github/PureCN_manuscript_backup/Figures/Final_Figures/Fig1F.luad_loh.rds")
```