...
```{r}
out.dir_luad = "/data/ovarian/CNVworkflow_LUAD/purecn_output/Benchmark/tumor_only"
output_luad = list.files(out.dir_luad)
...
saveRDS(benchmark_luad, 
        file.path(results_dir, "benchmark/data/all_luad_benchmark.rds"))
```