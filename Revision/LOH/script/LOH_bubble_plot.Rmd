...
```{r echo=FALSE}
saveRDS(loh_list_pcn, "~/data2/PureCN_manuscript/Revision/LOH/loh_list_pcn.rds")
# saveRDS(loh_list_abs, "~/data2/PureCN_manuscript/Revision/LOH/loh_list_abs.rds")

loh_list_pcn = readRDS("~/data2/PureCN_manuscript/Revision/LOH/loh_list_pcn.rds")
loh_list_abs = readRDS("~/data2/PureCN_manuscript/Revision/LOH/loh_list_abs.rds")
```
...
```{r echo=FALSE}
saveRDS(loh_summary, "~/data2/PureCN_manuscript/Revision/LOH/loh_summary.rds")

loh_summary = readRDS("~/data2/PureCN_manuscript/Revision/LOH/loh_summary.rds")
```
...
# loh.pcn_na = c("1.5-1","1.50432977574171-0","0.191336671662991-0",
#                "0.0699034009267365-0","9.26034726026929-1")
# loh.pcn_na_ind = which(test$loh.pcn %in% loh.pcn_na)
# test = test[-loh.pcn_na_ind,]

# test = test %>%
#     dplyr::group_by(loh.abs) %>%
#     dplyr::group_by(loh.pcn) %>%
#     dplyr::summarise(., n())
...
ggplot(t2, aes(x = loh.abs, y = loh.pcn)) +   # 30,335 data points
