...
```{r}
abs_gl_hg38 = readRDS("~/Documents/github/PureCN_manuscript/Results/ABSOLUTE/ABSOLUTE_OV_grangeslist_all_hg38.rds")
...
```{r eval=FALSE}
write.csv(ABS_LOH_all, file = "~/Documents/github/PureCN_manuscript/Results/LOH/extdata/ABS_LOH_all.tsv")
```

## Combine TP53 LOH results
```{r echo=FALSE}
ABS_LOH_all = read.csv("~/Documents/github/PureCN_manuscript/Results/LOH/extdata/ABS_LOH_all.tsv")[,-1]
```

##### Load all PureCN outputs: both from 931070 and S0293689
```{r}
data_dir = "~/Documents/github/PureCN_manuscript/Results/LOH/extdata"
...
##### Save
```{r eval=FALSE}
write.csv(TP53_all, file = "~/Documents/github/PureCN_manuscript/Results/LOH/extdata/TP53_all.tsv")
```
...
##### Save
```{r eval=FALSE}
write.csv(HLA_all, file = "~/Documents/github/PureCN_manuscript/Results/LOH/extdata/HLA_all.tsv")
```
