...
## Figure 1
* File under `/Users/sehyunoh/wallabe4_backup/github/PureCN_manuscript_backup/Figures`   
    + F1A/B: `manuscript_puri_ploi.Rmd`
    + F1E: `manuscript_loh_t_plots.Rmd`
* File under `/Users:/sehyunoh/wallabe4_backup/github/PureCN_manuscript_backup/luad/Figures`
    + F1C/D: `luad_manuscript_puri_ploi.Rmd`
    + F1F: `luad_manuscript_loh_t_plots.Rmd`
    
```{r}
data_dir = "~/wallabe4_backup/github/PureCN_manuscript_backup/Figures/Final_Figures"
...
F1E = readRDS(file.path(data_dir, "Fig1E.ovc_loh.rds"))
F1F = readRDS(file.path(data_dir, "Fig1F.luad_loh.rds"))
```
...
```{r eval=FALSE, fig.width=5.5, fig.height=7}
F1E / F1F
```
...
## Sup. Figure 2
* File under `/Users/sehyunoh/wallabe4_backup/github/FACETS`   
